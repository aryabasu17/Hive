            ...
            >
              ...
              <div className="py-5 sm:flex sm:flex-row-reverse border-t border-[#66666645]">
                {isSubmitting ? (
                  ...
                  <CustomButton
                    type="submit"
                    containerStyles={`inline-flex justify-center rounded-md bg-violet hover:bg-[#9b5ad680] hover:ease-in hover:text-[#fff px-8 py-3 text-sm font-medium text-white outline-none`}
                    title="Submit"
                  />
                )}
              </div>
