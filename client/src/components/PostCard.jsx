      ...
      <div className="flex gap-3 items-center mb-1">
        ...
        <div>
          ...
          <span className="text-ascent-2 text-sm">
            {moment(reply?.createdAt ?? "2024-05-06").fromNow()}
          </span>
        </div>
      </div>
        ...
        <div className="mt-2 flex gap-6">
          ...
          >
            {reply?.likes?.includes(user?._id) ? (
              <BiSolidLike size={20} color="#7c18d9" />
            ) : (
              <BiLike size={20} />
            )}
      ...
      <div className="flex items-end justify-end pb-2">
        {loading ? (
          ...
          <CustomButton
            title="Submit"
            type="submit"
            containerStyles="bg-[#7c18d9] text-white py-1 px-3 rounded-full font-semibold text-sm"
          />
        )}
      </div>
    </form>
      ...
      <div>
        <p className="text-ascent-2">
          ...
          {post?.description?.length > 300 &&
            (showAll === post?._id ? (
              <span
                className="text-[#9b5ad6] ml-2 font-medium cursor-pointer"
